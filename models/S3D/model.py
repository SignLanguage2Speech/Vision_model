...
class S3D(nn.Module):
    def __init__(self, use_block):
        ...
        base_seq = []
        # block 1
        block_1 = [SepConv3d(3, 64, kernel_size=7, stride=2, padding=3)]
        # block 2
        block_2 = [nn.MaxPool3d(kernel_size=(1,3,3), stride=(1,2,2), padding=(0,1,1)),
        BasicConv3d(64, 64, kernel_size=1, stride=1),
        SepConv3d(64, 192, kernel_size=3, stride=1, padding=1)]
        # block 3
        block_3 =[nn.MaxPool3d(kernel_size=(1,3,3), stride=(1,2,2), padding=(0,1,1)),
        Mixed_3b(),  Mixed_3c()]
        # block 4
        block_4 = [nn.MaxPool3d(kernel_size=(3,3,3), stride=(2,2,2), padding=(1,1,1)),
        Mixed_4b(), Mixed_4c(), Mixed_4d(), Mixed_4e(), Mixed_4f()]
        # block 5
        block_5 = [nn.MaxPool3d(kernel_size=(2,2,2), stride=(2,2,2), padding=(0,0,0)),
        Mixed_5b(), Mixed_5c()]
